document.addEventListener('DOMContentLoaded', async () => {
    ...
    async function loadData() {
        try {
            ...
            typeWords = vocabularyData.typeWords || {}; // typeWords'u JSON'dan çekiyoruz.
    ...
    function highlightWords(text) {
        ...
        // TypeWords işaretleme
        for (const [typeKey, typeValue] of Object.entries(typeWords)) {
            const regex = new RegExp(`\\b${typeValue}\\b`, 'gi');
            resultText = resultText.replace(regex, `<span class="y">$&</span>`);
        }
